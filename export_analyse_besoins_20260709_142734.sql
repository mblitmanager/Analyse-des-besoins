...
CREATE TABLE public.parcours_rules (
    ...
    hiddenresulttype character varying(20) DEFAULT NULL::character varying
);
...
aa6d99a0-404c-48a0-9f8c-3288fad95a5d	Gimp	\N	gimp	\N	EXCLUDE	toeic,voltaire		t	0	lte
\.
...
COPY public.p3_override_rules (id, formation, "formationId", condition, formation1, formation2, "order", "isActive", certification, "explanationMessage", "parcoursTitle", "conditionP1", "conditionP2", "requireTest", "forceChoice") FROM stdin;
271	Word	44	Si résultat du test = Basique	EXCEL Basique (TOSA)		1	t	\N	WORD Basique (TOSA) + WORD Opérationnel (ICDL) -> EXCEL Basique (TOSA)	Renforcement Word - P3	WORD Basique (TOSA)	WORD Opérationnel (ICDL)	f	t
272	Word	44	Si résultat du test = Basique	PPT Basique (TOSA)		2	t	\N	WORD Basique (TOSA) + WORD Opérationnel (ICDL) -> PPT Basique (TOSA)	Renforcement Word - P3	WORD Basique (TOSA)	WORD Opérationnel (ICDL)	f	t
273	Word	44	Si résultat du test = Basique	OUTLOOK Basique (TOSA)		3	t	\N	WORD Basique (TOSA) + WORD Opérationnel (ICDL) -> OUTLOOK Basique (TOSA)	Renforcement Word - P3	WORD Basique (TOSA)	WORD Opérationnel (ICDL)	f	t
274	Excel	45	Si résultat du test ≤ Basique	WORD Basique (TOSA)		1	t	\N	EXCEL Basique (TOSA) + EXCEL Opérationnel (ICDL) -> WORD Basique (TOSA)	Renforcement Excel - P3	EXCEL Basique (TOSA)	EXCEL Opérationnel (ICDL)	f	t
275	Excel	45	Si résultat du test ≤ Basique	PPT Basique (TOSA)		2	t	\N	EXCEL Basique (TOSA) + EXCEL Opérationnel (ICDL) -> PPT Basique (TOSA)	Renforcement Excel - P3	EXCEL Basique (TOSA)	EXCEL Opérationnel (ICDL)	f	t
276	Excel	45	Si résultat du test ≤ Basique	OUTLOOK Basique (TOSA)		3	t	\N	EXCEL Basique (TOSA) + EXCEL Opérationnel (ICDL) -> OUTLOOK Basique (TOSA)	Renforcement Excel - P3	EXCEL Basique (TOSA)	EXCEL Opérationnel (ICDL)	f	t
277	Excel	45	Si résultat du test EXCEL = Opérationnel	WORD Basique (TOSA)		4	t	\N	EXCEL Opérationnel (ICDL) + EXCEL Expert (TOSA) -> WORD Basique (TOSA)	Expertise Excel - P3	EXCEL Opérationnel (ICDL)	EXCEL Expert (TOSA)	f	t
278	Excel	45	Si résultat du test EXCEL = Opérationnel	PPT Basique (TOSA)		5	t	\N	EXCEL Opérationnel (ICDL) + EXCEL Expert (TOSA) -> PPT Basique (TOSA)	Expertise Excel - P3	EXCEL Opérationnel (ICDL)	EXCEL Expert (TOSA)	f	t
279	Excel	45	Si résultat du test EXCEL = Opérationnel	OUTLOOK Opérationnel (ICDL)		6	t	\N	EXCEL Opérationnel (ICDL) + EXCEL Expert (TOSA) -> OUTLOOK Opérationnel (ICDL)	Expertise Excel - P3	EXCEL Opérationnel (ICDL)	EXCEL Expert (TOSA)	f	t
283	Français	51	Si résultat du test FRANÇAIS = Technique	Français Affaires (VOLTAIRE)		1	t	\N	Français Technique (VOLTAIRE) + Français Professionnel (VOLTAIRE) -> Français Affaires (VOLTAIRE)	Renforcement Français - P3	Français Technique (VOLTAIRE)	Français Professionnel (VOLTAIRE)	f	t
284	PowerPoint	54	Si résultat du test ≤ Basique	WORD Basique (TOSA)		1	t	\N	PPT Basique (TOSA) + PPT Opérationnel (ICDL) -> WORD Basique (TOSA)	Renforcement Powerpoint - P3	PPT Basique (TOSA)	PPT Opérationnel (ICDL)	f	t
285	PowerPoint	54	Si résultat du test ≤ Basique	EXCEL Basique (TOSA)		2	t	\N	PPT Basique (TOSA) + PPT Opérationnel (ICDL) -> EXCEL Basique (TOSA)	Renforcement Powerpoint - P3	PPT Basique (TOSA)	PPT Opérationnel (ICDL)	f	t
286	PowerPoint	54	Si résultat du test ≤ Basique	OUTLOOK Basique (TOSA)		3	t	\N	PPT Basique (TOSA) + PPT Opérationnel (ICDL) -> OUTLOOK Basique (TOSA)	Renforcement Powerpoint - P3	PPT Basique (TOSA)	PPT Opérationnel (ICDL)	f	t
287	Mixte Microsoft Office (Word + Excel)	57	Si résultat du test ≤ Basique	PPT Basique (TOSA)		1	t	\N	WORD Basique (TOSA) + EXCEL Basique (TOSA) -> PPT Basique (TOSA)	Essentiels Bureautique - P3	WORD Basique (TOSA)	EXCEL Basique (TOSA)	f	t
288	Mixte Microsoft Office (Word + Excel)	57	Si résultat du test ≤ Basique	OUTLOOK Basique (TOSA)		2	t	\N	WORD Basique (TOSA) + EXCEL Basique (TOSA) -> OUTLOOK Basique (TOSA)	Essentiels Bureautique - P3	WORD Basique (TOSA)	EXCEL Basique (TOSA)	f	t
268	Anglais	25	≤ Niveau B1	Niveau B2 - TOEIC		1	t	\N		"Renforcement Anglais" (A2 & B1) - TOEIC - P3	Niveau A2 - TOEIC	Niveau B1 - TOEIC	f	t
264	Digitales Compétences	23	≤ Basique	WORD Basique (TOSA)		15	t	\N	Digitales Compétences Basique (TOSA) + OUTLOOK Basique (TOSA) -> WORD Basique (TOSA)	Renforcement Digital Compétence - P3	Digitales Compétences Basique (TOSA)	OUTLOOK Basique (TOSA)	f	t
263	Digitales Compétences	23	≤ Basique	PPT Basique (TOSA)		14	t	\N	Digitales Compétences Basique (TOSA) + OUTLOOK Basique (TOSA) -> PPT Basique (TOSA)	Renforcement Digital Compétence - P3	Digitales Compétences Basique (TOSA)	OUTLOOK Basique (TOSA)	f	t
280	Gimp	48	<= Opérationnel	GIMP Opérationnel (ICDL)		1	t	\N	GIMP Opérationnel (ICDL) + ILLUSTRATOR Opérationnel (TOSA) -> IA GENERATIVE (INKREA)	Création graphique - P3	ICDL GIMP Opérationnel	ILLUSTRATOR Opérationnel (TOSA)	f	t
281	Gimp	48	<= Opérationnel	GIMP Opérationnel (ICDL)		2	t	\N	GIMP Opérationnel (ICDL) + ILLUSTRATOR Opérationnel (TOSA) -> SKETCHUP Opérationnel (ICDL)	Création graphique - P3	ICDL GIMP Opérationnel	ILLUSTRATOR Opérationnel (ICDL)	f	t
282	Gimp	48	<= Opérationnel	GIMP Opérationnel (ICDL)		3	t	\N	GIMP Opérationnel (ICDL) + ILLUSTRATOR Opérationnel (TOSA) -> PHOTOSHOP Basique (TOSA)	Création graphique - P3	ICDL GIMP Opérationnel	ILLUSTRATOR Opérationnel (ICDL)	f	t
289	Mixte Microsoft Office (Word + Excel)	57	Si résultat du test = Opérationnel	EXCEL Expert (TOSA)		3	t	\N	WORD Opérationnel (ICDL) + EXCEL Opérationnel (ICDL) -> EXCEL Expert (TOSA)	Perfectionnement Bureautique - P3	WORD Opérationnel (ICDL)	EXCEL Opérationnel (ICDL)	f	t
241	Illustrator	19	Si résultat du test ≤ Basique	IA GENERATIVE (INKREA)		1	t	\N	ILLUSTRATOR Basique (TOSA) + ILLUSTRATOR Opérationnel (ICDL) -> IA GENERATIVE (INKREA)	Renforcement Illustrator - P3	ILLUSTRATOR Basique (TOSA)	ILLUSTRATOR Opérationnel (ICDL)	f	t
245	SketchUp	21	Si résultat du test ≤ Basique	IA GENERATIVE (INKREA)		1	t	\N	SKETCHUP Opérationnel (ICDL) + GIMP Opérationnel (ICDL) -> IA GENERATIVE (INKREA)	Création visuels : 3D/Images - P3	SKETCHUP Opérationnel (ICDL)	GIMP Opérationnel (ICDL)	f	t
246	SketchUp	21	Si résultat du test ≤ Basique	ILLUSTRATOR Basique (TOSA)		2	t	\N	SKETCHUP Opérationnel (ICDL) + GIMP Opérationnel (ICDL) -> ILLUSTRATOR Basique (TOSA)	Création visuels : 3D/Images - P3	SKETCHUP Opérationnel (ICDL)	GIMP Opérationnel (ICDL)	f	t
247	WordPress	22	Si résultat du test ≤ Basique	IA GENERATIVE (INKREA)		1	t	\N	WORDPRESS Basique (TOSA) + WORDPRESS Opérationnel (ICDL) -> IA GENERATIVE (INKREA)	Renforcement Wordpress - P3	WORDPRESS Basique (TOSA)	WORDPRESS Opérationnel (ICDL)	f	t
248	WordPress	22	Si résultat du test ≤ Basique	SKETCHUP Opérationnel (ICDL)		2	t	\N	WORDPRESS Basique (TOSA) + WORDPRESS Opérationnel (ICDL) -> SKETCHUP Opérationnel (ICDL)	Renforcement Wordpress - P3	WORDPRESS Basique (TOSA)	WORDPRESS Opérationnel (ICDL)	f	t
249	WordPress	22	Si résultat du test ≤ Basique	PHOTOSHOP Basique (TOSA)		3	t	\N	WORDPRESS Basique (TOSA) + WORDPRESS Opérationnel (ICDL) -> PHOTOSHOP Basique (TOSA)	Renforcement Wordpress - P3	WORDPRESS Basique (TOSA)	WORDPRESS Opérationnel (ICDL)	f	t
253	Digitales Compétences	23	≤ Basique	WORD Opérationnel (ICDL)		4	t	\N	Digitales Compétences Basique (TOSA) + WORD Basique (TOSA) -> WORD Opérationnel (ICDL)	Essentiels Digitales Compétences & Word - P3	Digitales Compétences Basique (TOSA)	WORD Basique (TOSA)	f	t
257	Digitales Compétences	23	Si résultat du test ≤ Basique	EXCEL Opérationnel (ICDL)		8	t	\N	Digitales Compétences Basique (TOSA) + EXCEL Basique (TOSA) -> EXCEL Opérationnel (ICDL)	Essentiels Digitales Compétences & Excel - P3	Digitales Compétences Basique (TOSA)	EXCEL Basique (TOSA)	f	t
260	Digitales Compétences	23	≤ Basique	OUTLOOK Basique (TOSA)		11	t	\N	Digitales Compétences Basique (TOSA) + PPT Basique (TOSA) -> OUTLOOK Basique (TOSA)	Essentiels Digitales Compétences & PPT - P3	Digitales Compétences Basique (TOSA)	PowerPoint Basique (TOSA)	t	t
242	Photoshop	20	Si résultat du test ≤ Basique	IA GENERATIVE (INKREA)		1	t	\N	PHOTOSHOP basique (TOSA) + PHOTOSHOP Opérationnel (ICDL) -> IA GENERATIVE (INKREA)	Renforcement Photoshop - P3	PHOTOSHOP Basique (TOSA)	PHOTOSHOP Opérationnel (ICDL)	f	t
243	Photoshop	20	Si résultat du test ≤ Basique	SKETCHUP Opérationnel (ICDL)		2	t	\N	PHOTOSHOP basique (TOSA) + PHOTOSHOP Opérationnel (ICDL) -> SKETCHUP Opérationnel (ICDL)	Renforcement Photoshop - P3	PHOTOSHOP Basique (TOSA)	PHOTOSHOP Opérationnel (ICDL)	f	t
251	Digitales Compétences	23	≤ Basique	PPT Basique (TOSA)		2	t	\N	Digitales Compétences Basique (TOSA) + WORD Basique (TOSA) -> PPT Basique (TOSA)	Essentiels Digitales Compétences & Word - P3	Digitales Compétences Basique (TOSA)	WORD Basique (TOSA)	t	t
252	Digitales Compétences	23	≤ Basique	OUTLOOK Basique (TOSA)		3	t	\N	Digitales Compétences Basique (TOSA) + WORD Basique (TOSA) -> OUTLOOK Basique (TOSA)	Essentiels Digitales Compétences & Word - P3	Digitales Compétences Basique (TOSA)	WORD Basique (TOSA)	t	t
254	Digitales Compétences	23	≤ Basique	WORD Basique (TOSA)		5	t	\N	Digitales Compétences Basique (TOSA) + EXCEL Basique (TOSA) -> WORD Basique (TOSA)	Essentiels Digitales Compétences & Excel - P3	Digitales Compétences Basique (TOSA)	EXCEL Basique (TOSA)	t	t
255	Digitales Compétences	23	≤ Basique	PPT Basique (TOSA)		6	t	\N	Digitales Compétences Basique (TOSA) + EXCEL Basique (TOSA) -> PPT Basique (TOSA)	Essentiels Digitales Compétences & Excel - P3	Digitales Compétences Basique (TOSA)	EXCEL Basique (TOSA)	t	t
256	Digitales Compétences	23	≤ Basique	OUTLOOK Basique (TOSA)		7	t	\N	Digitales Compétences Basique (TOSA) + EXCEL Basique (TOSA) -> OUTLOOK Basique (TOSA)	Essentiels Digitales Compétences & Excel - P3	Digitales Compétences Basique (TOSA)	EXCEL Basique (TOSA)	t	t
258	Digitales Compétences	23	<= Basique	EXCEL Basique (TOSA)		9	t	\N	Digitales Compétences Basique (TOSA) + PPT Basique (TOSA) -> EXCEL Basique (TOSA)	Essentiels Digitales Compétences & PPT - P3	Digitales Compétences Basique (TOSA)	PowerPoint Basique (TOSA)	t	t
259	Digitales Compétences	23	≤ Basique	WORD Basique (TOSA)		10	t	\N	Digitales Compétences Basique (TOSA) + PPT Basique (TOSA) -> WORD Basique (TOSA)	Essentiels Digitales Compétences & PPT - P3	Digitales Compétences Basique (TOSA)	PowerPoint Basique (TOSA)	t	t
261	Digitales Compétences	23	Si résultat du test ≤ Basique	PPT Opérationnel (ICDL)		12	t	\N	Digitales Compétences Basique (TOSA) + PPT Basique (TOSA) -> PPT Opérationnel (ICDL)	Essentiels Digitales Compétences & PPT - P3	Digitales Compétences Basique (TOSA)	PPT Basique (TOSA)	f	t
262	Digitales Compétences	23	Si résultat du test ≤ Basique	EXCEL Basique (TOSA)		13	t	\N	Digitales Compétences Basique (TOSA) + OUTLOOK Basique (TOSA) -> EXCEL Basique (TOSA)	Renforcement Digital Compétence - P3	Digitales Compétences Basique (TOSA)	OUTLOOK Basique (TOSA)	f	t
265	Digitales Compétences	23	= Opérationnel	SHEETS Opérationnel (ICDL)		16	t	\N	Digitales Compétences Opérationnel (TOSA) + OUTILS COLLABORATIFS (ICDL) -> GOOGLE SHEETS Opérationnel (ICDL)	Perfectionnement Digitales Compétences & Outils Coll. - P3	Digitales Compétences Opérationnel (TOSA)	Outils Collaboratifs Opérationnel (ICDL)	f	t
250	Digitales Compétences	23	≤ Basique	EXCEL Basique (TOSA)		1	t	\N	Digitales Compétences Basique (TOSA) + WORD Basique (TOSA) -> EXCEL Basique (TOSA)	Essentiels Digitales Compétences & Word - P3	Digitales Compétences Basique (TOSA)	WORD Basique (TOSA)	t	t
269	Anglais	25	= Niveau B2	Niveau C1 - TOEIC		2	t	\N	Niveau B1 - TOEIC + Niveau B2 - TOEIC -> Niveau B2 - TOEIC	"Perfectionnement Anglais" : (B1 & B2) - TOEIC - P3	Niveau B2 - TOEIC	Niveau B2 - TOEIC	f	t
244	Photoshop	20	Si résultat du test ≤ Basique	ILLUSTRATOR Basique (TOSA)		3	t	\N	PHOTOSHOP basique (TOSA) + PHOTOSHOP Opérationnel (ICDL) -> ILLUSTRATOR Basique (TOSA)	Renforcement Photoshop - P3	PHOTOSHOP Basique (TOSA)	PHOTOSHOP Opérationnel (ICDL)	f	t
240	Google Slides	10	Si résultat du test ≤ Basique	IA GENERATIVE (INKREA)		1	t	\N	GOOGLE SLIDES Opérationnel(ICDL) + GOOGLE DOCS Opérationnel (ICDL) / GOOGLE SHEETS Opérationnel (ICDL) -> IA GENERATIVE (INKREA)	Bureautique Google (SLIDES) - P3	SLIDES Opérationnel (ICDL)	DOCS Opérationnel (ICDL) / SHEETS Opérationnel (ICDL)	f	t
239	Google Sheets	5	Si résultat du test ≤ Basique	IA GENERATIVE (INKREA)		1	t	\N	GOOGLE SHEETS Opérationnel (ICDL) + GOOGLE DOCS Opérationnel / GOOGLE SLIDES Opérationnel (ICDL) -> IA GENERATIVE (INKREA)	Bureautique Google (SHEETS) - P3	SHEETS Opérationnel (ICDL)	DOCS Opérationnel (ICDL) / SLIDES Opérationnel (ICDL)	f	t
238	Google Docs	4	Si résultat du test ≤ Basique	IA GENERATIVE (INKREA)		1	t	\N	GOOGLE DOCS Opérationnel (ICDL) + GOOGLE SHEETS Opérationnel (ICDL) / GOOGLE SLIDES Opérationnel (ICDL) -> IA GENERATIVE (INKREA)	Bureautique Google (DOCS) - P3	DOCS Opérationnel (ICDL)	SHEETS Opérationnel (ICDL) / SLIDES Opérationnel (ICDL)	f	t
270	Outils Collaboratifs Google	43	Si résultat du test ≤ Basique	IA GENERATIVE (INKREA)		1	t	\N	OUTILS COLLABORATIFS Opérationnel (ICDL) + GOOGLE DOCS Opérationnel (ICDL) / GOOGLE SHEETS Opérationnel (ICDL) / GOOGLE SLIDES Opérationnel (ICDL) / Digitales Compétences Opérationnel (TOSA) -> IA GENERATIVE (INKREA)	Google Workspace - P3	Outils Collaboratifs Opérationnel (ICDL)	DOCS Opérationnel (ICDL) / SHEETS Opérationnel (ICDL) / SLIDES Opérationnel (ICDL) / Digitales Compétences Opérationnel (TOSA)	f	t
266	Digitales Compétences	23	= Opérationnel	DOCS Opérationnel (ICDL)		17	t	\N	Digitales Compétences Opérationnel (TOSA) + OUTILS COLLABORATIFS (ICDL) -> GOOGLE DOCS Opérationnel (ICDL)	Perfectionnement Digitales Compétences & Outils Coll. - P3	Digitales Compétences Opérationnel (TOSA)	Outils Collaboratifs Opérationnel (ICDL)	f	t
267	Digitales Compétences	23	= Opérationnel	SLIDES Opérationnel (ICDL)		18	t	\N	Digitales Compétences Opérationnel (TOSA) + OUTILS COLLABORATIFS (ICDL) -> GOOGLE SLIDES Opérationnel (ICDL)	Perfectionnement Digitales Compétences & Outils Coll. - P3	Digitales Compétences Opérationnel (TOSA)	Outils Collaboratifs Opérationnel (ICDL)	f	t
\.
...
COPY public.parcours_rules (id, formation, condition, formation1, formation2, "isActive", "requirePrerequisiteFailure", "order", certification, "prerequisiteConditions", "prerequisiteLogic", "formationId", "explanationMessage", "parcoursTitle", "selectionConditions", "selectionConditionLogic", "isHiddenResult", "hiddenResultType", hiddenresulttype) FROM stdin;
418	Français	Si résultat du test FRANÇAIS = Professionnel	Français Professionnel (VOLTAIRE)	Français Affaires (VOLTAIRE)	t	f	2	\N	\N	OR	51	Professionnel + Affaires	Perfectionnement Français	\N	AND	f	\N	\N
433	Mixte Microsoft Office (Word + Excel)	Si résultat du test ≤ Basique	WORD Basique (TOSA)	EXCEL Basique (TOSA)	t	f	0		[]	OR	57		Essentiels Bureautique	\N	AND	f	\N	\N
434	Mixte Microsoft Office (Word + Excel)	Si résultat du test = Opérationnel	WORD Opérationnel (ICDL)	EXCEL Opérationnel (ICDL)	t	f	1		[]	OR	57		Perfectionnement Bureautique	\N	AND	f	\N	\N
430	Excel + IA	Si résultat du test ≤ Opérationnel	IA GENERATIVE (INKREA)	EXCEL Opérationnel (TOSA)	t	f	0		[]	OR	55		IA Générative 	\N	AND	f	\N	\N
438	Digitales Compétences	Si résultat du test ≤ Basique	Digitales Compétences Basique (TOSA)	Excel Basique (TOSA)	t	f	2		[]	OR	23		Essentiels Digitales Compétences & Excel	[]	AND	f	\N	\N
436	Digitales Compétences	Si résultat du test ≤ Basique	Digitales Compétences Basique (TOSA)	Outlook Opérationnel (TOSA)	t	f	4		[]	OR	23		Renforcement Digital Compétence + OUTLOOK	[]	AND	f	\N	\N
398	Digitales Compétences	Si résultat du test DIGCOMP = Opérationnel	Digitales Compétences Opérationnel (TOSA)	Outils Collaboratifs Google Opérationnel (ICDL)	t	f	5		[]	OR	23		Perfectionnement Digital Compétence + Outils Collaboratifs 	[]	AND	f	\N	\N
432	Outlook	Si résultat du test ≤ Basique	OUTLOOK Basique (TOSA)	OUTLOOK Opérationnel (ICDL)	t	f	0		[]	OR	15		Renforcement Outlook	\N	AND	f	\N	\N
461	Gimp	Si résultat du test <= Initial	GIMP Opérationnel (ICDL)	ILLUSTRATOR Opérationnel (TOSA)	f	f	0	\N	\N	OR	\N	Votre niveau GIMP est insuffisant pour cette formation. Nous vous invitons à choisir une formation plus adaptée ou à continuer ci-dessous si vous souhaitez tout de même vous lancer.	Niveau insuffisant	\N	AND	t	too_weak	\N
417	Français	Si résultat du test ≤ Technique	Français Technique (VOLTAIRE)	Français Professionnel (VOLTAIRE)	t	f	1		[]	OR	51	Technique + Professionnel	Renforcement Français	[]	AND	f	\N	\N
427	Anglais 	Si résultat du test ≤ Niveau A2	Niveau A2 - TOEIC	Niveau B1 - TOEIC	t	f	1		[]	OR	25		"Renforcement Anglais" (A2 & B1) - TOEIC	[]	AND	f	\N	\N
429	Anglais 	Si résultat du test = Niveau B2	Niveau B2 - TOEIC	Niveau C1 - TOEIC	t	f	3		[]	OR	25		"Expertise Anglais"  : (B2 & C1) - TOEIC	[]	AND	f	\N	\N
428	Anglais 	Si résultat du test = Niveau B1	Niveau B1 - TOEIC	Niveau B2 - TOEIC	t	f	2		[]	OR	25		"Perfectionnement Anglais" : (B1 & B2) - TOEIC	[]	AND	f	\N	\N
401	Excel	Si résultat du test EXCEL = Opérationnel	EXCEL Opérationnel (ICDL)	EXCEL Expert (TOSA)	t	f	4		[]	OR	45		Expertise EXCEL	[]	AND	f	\N	\N
400	Excel	Si résultat du test = Basique	EXCEL Basique (TOSA)	EXCEL Opérationnel (ICDL)	t	f	2		[]	OR	45		Renforcement EXCEL	[]	AND	f	\N	\N
462	Gimp	Si résultat du test <= Initial	GIMP Opérationnel (ICDL)	ILLUSTRATOR Opérationnel (TOSA)	t	f	1	\N	\N	OR	\N	\N	Création Graphique	\N	AND	f	\N	\N
411	Gimp	Si résultat du test = Basique	GIMP Opérationnel (ICDL)	ILLUSTRATOR Opérationnel (TOSA)	t	f	2		[]	OR	48		Création Graphique	\N	AND	f	\N	\N
412	Illustrator	Si résultat du test ≤ Basique	ILLUSTRATOR Basique (TOSA)	ILLUSTRATOR Opérationnel (ICDL)	t	f	1		[]	OR	19		Renforcement ILLUSTRATOR	\N	AND	f	\N	\N
485	Outils Collaboratifs Google	Si résultat du test ≤ Basique	Outils Collaboratifs Opérationnel (ICDL)	Digitales Compétences Opérationnel (TOSA)	t	f	4	\N	\N	OR	\N	\N	Google WORKSPACE (OC & Digitales Compétences)	\N	AND	f	\N	\N
486	Outils Collaboratifs Google	Si résultat du test ≤ Basique	Outils Collaboratifs Opérationnel (ICDL)	IA GENERATIVE (INKREA)	t	f	5	\N	\N	OR	\N	\N	Google WORKSPACE (OC & IA Générative)	\N	AND	f	\N	\N
443	Excel	Si résultat du test = Basique	WORD Basique (TOSA)	EXCEL Basique (TOSA)	t	f	3		[]	OR	45		Essentiels WORD + EXCEL	[]	AND	f	\N	\N
439	Word	Si résultat du test = Basique	WORD Basique (TOSA)	EXCEL Basique (TOSA)	t	f	3		[]	OR	44		Essentiels WORD & EXCEL	[]	AND	f	\N	\N
444	Excel	Si résultat du test = Opérationnel	WORD Opérationnel (TOSA)	EXCEL Opérationnel (TOSA)	t	f	5		[]	OR	45		Perfectionnement WORD + EXCEL	[]	AND	f	\N	\N
473	Google Sheets	Si résultat du test = Opérationnel	SHEETS Opérationnel (ICDL)	DOCS Opérationnel (ICDL)	f	f	3	\N	\N	OR	\N	Votre niveau Google Sheets est déjà avancé. Cette formation ne correspond pas à votre profil. Nous vous invitons à choisir une formation plus adaptée ou à continuer ci-dessous si vous souhaitez tout de même suivre ce parcours.	Niveau trop avancé	\N	AND	t	too_advanced	\N
476	Google Docs	Si résultat du test = Opérationnel	DOCS Opérationnel (ICDL)	SHEETS Opérationnel (ICDL)	f	f	3	\N	\N	OR	\N	Votre niveau Google Docs est déjà avancé. Cette formation ne correspond pas à votre profil. Nous vous invitons à choisir une formation plus adaptée ou à continuer ci-dessous si vous souhaitez tout de même suivre ce parcours.	Niveau trop avancé	\N	AND	t	too_advanced	\N
469	SketchUp	Si résultat du test = Opérationnel	SKETCHUP Opérationnel (ICDL)	GIMP Opérationnel (ICDL)	f	f	3	\N	\N	OR	\N	Votre niveau SketchUp est déjà avancé. Cette formation ne correspond pas à votre profil. Nous vous invitons à choisir une formation plus adaptée ou à continuer ci-dessous si vous souhaitez tout de même suivre ce parcours.	Niveau trop avancé	\N	AND	t	too_advanced	\N
479	Google Slides	Si résultat du test = Opérationnel	SLIDES Opérationnel (ICDL)	DOCS Opérationnel (ICDL)	f	f	3	\N	\N	OR	\N	Votre niveau Google Slides est déjà avancé. Cette formation ne correspond pas à votre profil. Nous vous invitons à choisir une formation plus adaptée ou à continuer ci-dessous si vous souhaitez tout de même suivre ce parcours.	Niveau trop avancé	\N	AND	t	too_advanced	\N
403	Outils Collaboratifs Google	Si résultat du test ≤ Basique	Outils Collaboratifs Google Opérationnel (ICDL)	Google Docs Opérationnel (ICDL)	t	f	1		[]	OR	43		Google WORKSPACE (OC & DOCS)	[]	AND	f	\N	\N
459	Photoshop	Si résultat du test = Opérationnel	PHOTOSHOP Basique (TOSA)	PHOTOSHOP Opérationnel (ICDL)	f	f	2	\N	\N	OR	\N	Votre niveau Photoshop est déjà avancé. Cette formation ne correspond pas à votre profil. Nous vous invitons à choisir une formation plus adaptée ou à continuer ci-dessous si vous souhaitez tout de même suivre ce parcours.	Niveau trop avancé	\N	AND	t	too_advanced	\N
465	Illustrator	Si résultat du test = Opérationnel	ILLUSTRATOR Basique (TOSA)	ILLUSTRATOR Opérationnel (ICDL)	f	f	2	\N	\N	OR	\N	Votre niveau Illustrator est déjà avancé. Cette formation ne correspond pas à votre profil. Nous vous invitons à choisir une formation plus adaptée ou à continuer ci-dessous si vous souhaitez tout de même suivre ce parcours.	Niveau trop avancé	\N	AND	t	too_advanced	\N
463	Gimp	Si résultat du test = Opérationnel	GIMP Opérationnel (ICDL)	ILLUSTRATOR Opérationnel (ICDL)	f	f	3	\N	\N	OR	\N	Votre niveau GIMP est déjà avancé. Cette formation ne correspond pas à votre profil. Nous vous invitons à choisir une formation plus adaptée ou à continuer ci-dessous si vous souhaitez tout de même suivre ce parcours.	Niveau trop avancé	\N	AND	t	too_advanced	\N
471	Outils Collaboratifs Google	Si résultat du test = Opérationnel	Outils Collaboratifs Opérationnel (ICDL)	DOCS Opérationnel (ICDL)	f	f	4	\N	\N	OR	\N	Votre niveau en Outils Collaboratifs est déjà avancé. Cette formation ne correspond pas à votre profil. Nous vous invitons à choisir une formation plus adaptée ou à continuer ci-dessous si vous souhaitez tout de même suivre ce parcours.	Niveau trop avancé	\N	AND	t	too_advanced	\N
466	Illustrator	Si résultat du test = Opérationnel	ILLUSTRATOR Basique (TOSA)	ILLUSTRATOR Opérationnel (ICDL)	f	f	3	\N	\N	OR	\N	Si le bénéficiaire souhaite tout de même suivre une formation Illustrator.	Renforcement ILLUSTRATOR	\N	AND	f	\N	\N
464	Gimp	Si résultat du test = Opérationnel	GIMP Opérationnel (ICDL)	ILLUSTRATOR Opérationnel (ICDL)	f	f	4	\N	\N	OR	\N	Si le bénéficiaire souhaite tout de même suivre une formation GIMP.	Création Graphique	\N	AND	f	\N	\N
435	Word	Si résultat du test ≤ Initial	Digitales Compétences Basique (TOSA)	WORD Basique (TOSA)	t	f	1		[]	OR	44		Essentiels Digitales Compétences & WORD	\N	AND	f	\N	\N
442	Excel	Si résultat du test ≤ Initial	Digitales Compétences Basique (TOSA)	EXCEL Basique (TOSA)	t	f	1		[]	OR	45		Essentiels Digitales Compétences & EXCEL	[]	AND	f	\N	\N
445	PowerPoint	Si résultat du test ≤ Initial	Digitales Compétences Basique (TOSA)	PPT Basique (TOSA)	t	f	1		[]	OR	54		Essentiels Digitales Compétences & PPT	[]	AND	f	\N	\N
394	Digitales Compétences	Si résultat du test DIGCOMP ≤ Basique	Digitales Compétences Basique (TOSA)	Word Basique (TOSA)	t	f	1		[]	OR	23		Essentiels Digitales Compétences & Word	[]	AND	f	\N	\N
437	Digitales Compétences	Si résultat du test ≤ Basique	Digitales Compétences Basique (TOSA)	PowerPoint Basique (TOSA)	t	f	3		[]	OR	23		Essentiels Digital Compétence & PPT	[]	AND	f	\N	\N
482	Word	Si résultat du test = Opérationnel	WORD Opérationnel (TOSA)	EXCEL Opérationnel (TOSA)	t	f	4	\N	\N	OR	\N	Votre niveau WORD est déjà avancé pour cette formation. Nous vous proposons d'en choisir une autre ou de sélectionner un des parcours ci-dessous si vous souhaitez tout de même progresser en WORD.	Niveau trop avancé	\N	AND	t	too_advanced	\N
484	Word	Si résultat du test = Opérationnel	WORD Opérationnel (TOSA)	EXCEL Opérationnel (TOSA)	f	f	6	\N	\N	OR	\N	Si vous souhaitez tout de même suivre une formation WORD avancée.	Perfectionnement WORD + EXCEL	\N	AND	f	\N	\N
404	Outils Collaboratifs Google	Si résultat du test OC = Opérationnel	Outils Collaboratifs Opérationnel (ICDL)	DOCS Opérationnel (ICDL)	f	f	5	\N	\N	OR	43	Si le bénéficiaire souhaite tout de même suivre une formation Outils Collaboratifs.	Google WORKSPACE (OC & DOCS)	\N	AND	f	\N	\N
409	Photoshop	Si résultat du test ≤ Basique	PHOTOSHOP Basique (TOSA)	PHOTOSHOP Opérationnel (ICDL)	t	f	1		[]	OR	20		Renforcement PHOTOSHOP	\N	AND	f	\N	\N
460	Photoshop	Si résultat du test = Opérationnel	PHOTOSHOP Basique (TOSA)	PHOTOSHOP Opérationnel (ICDL)	f	f	3	\N	\N	OR	\N	Si le bénéficiaire souhaite tout de même suivre une formation Photoshop.	Renforcement PHOTOSHOP	\N	AND	f	\N	\N
402	PowerPoint	Si résultat du test ≤ Basique	PPT Basique (TOSA)	PPT Opérationnel (ICDL)	t	f	2		[]	OR	54		Renforcement PPT	\N	AND	f	\N	\N
456	PowerPoint	Si résultat du test = Opérationnel	PPT Basique (TOSA)	PPT Opérationnel (ICDL)	f	f	4	\N	\N	OR	\N	Si le bénéficiaire souhaite tout de même suivre une formation PowerPoint.	Renforcement PPT	\N	AND	f	\N	\N
448	Outils Collaboratifs Google	Si résultat du test = Opérationnel	Digitales Compétences Opérationnel (TOSA)	Outils Collaboratifs Opérationnel (ICDL)	f	f	8		[]	OR	43	Si le bénéficiaire souhaite tout de même suivre une formation Outils Collaboratifs.	Perfectionnement Digital Compétence + OC	[]	AND	f	\N	\N
474	Google Sheets	Si résultat du test = Opérationnel	SHEETS Opérationnel (ICDL)	DOCS Opérationnel (ICDL)	f	f	4	\N	\N	OR	\N	Si le bénéficiaire souhaite tout de même suivre une formation Google Sheets.	Bureautique Google WORKSPACE (SHEETS & DOCS)	\N	AND	f	\N	\N
477	Google Docs	Si résultat du test = Opérationnel	DOCS Opérationnel (ICDL)	SHEETS Opérationnel (ICDL)	f	f	4	\N	\N	OR	\N	Si le bénéficiaire souhaite tout de même suivre une formation Google Docs.	Bureautique Google WORKSPACE (DOCS & SHEETS)	\N	AND	f	\N	\N
446	Outils Collaboratifs Google	Si résultat du test ≤ Basique	Outils Collaboratifs Opérationnel (ICDL)	SHEETS Opérationnel (ICDL)	t	f	2		[]	OR	43		Google WORKSPACE (OC & SHEETS)	[]	AND	f	\N	\N
472	Outils Collaboratifs Google	Si résultat du test = Opérationnel	Outils Collaboratifs Opérationnel (ICDL)	SHEETS Opérationnel (ICDL)	f	f	6	\N	\N	OR	\N	Si le bénéficiaire souhaite tout de même suivre une formation Outils Collaboratifs.	Google WORKSPACE (OC & SHEETS)	\N	AND	f	\N	\N
410	SketchUp	Si résultat du test = Basique	SKETCHUP Opérationnel (ICDL)	GIMP Opérationnel (ICDL)	t	f	2		[]	OR	21		Création visuels : 3D / Images	\N	AND	f	\N	\N
468	SketchUp	Si résultat du test <= Initial	SKETCHUP Opérationnel (ICDL)	GIMP Opérationnel (ICDL)	t	f	1	\N	\N	OR	\N	\N	Création visuels : 3D / Images	\N	AND	f	\N	\N
470	SketchUp	Si résultat du test = Opérationnel	SKETCHUP Opérationnel (ICDL)	GIMP Opérationnel (ICDL)	f	f	4	\N	\N	OR	\N	Si le bénéficiaire souhaite tout de même suivre une formation SketchUp.	Création visuels : 3D / Images	\N	AND	f	\N	\N
480	Google Slides	Si résultat du test = Opérationnel	SLIDES Opérationnel (ICDL)	DOCS Opérationnel (ICDL)	f	f	4	\N	\N	OR	\N	Si le bénéficiaire souhaite tout de même suivre une formation Google Slides.	Bureautique Google WORKSPACE (SLIDES & DOCS)	\N	AND	f	\N	\N
481	Google Slides	Si résultat du test = Opérationnel	SLIDES Opérationnel (ICDL)	SHEETS Opérationnel (ICDL)	f	f	5	\N	\N	OR	\N	Si le bénéficiaire souhaite tout de même suivre une formation Google Slides.	Bureautique Google WORKSPACE (SLIDES & SHEETS)	\N	AND	f	\N	\N
478	Google Docs	Si résultat du test = Opérationnel	DOCS Opérationnel (ICDL)	SLIDES Opérationnel (ICDL)	f	f	5	\N	\N	OR	\N	Si le bénéficiaire souhaite tout de même suivre une formation Google Docs.	Bureautique Google WORKSPACE (DOCS & SLIDES)	\N	AND	f	\N	\N
447	Outils Collaboratifs Google	Si résultat du test ≤ Basique	Outils Collaboratifs Opérationnel (ICDL)	SLIDES Opérationnel (ICDL)	t	f	3		[]	OR	43		Google WORKSPACE (OC & SLIDES)	[]	AND	f	\N	\N
405	Outils Collaboratifs Google	Si résultat du test OC = Opérationnel	Outils Collaboratifs Opérationnel (ICDL)	SLIDES Opérationnel (ICDL)	f	f	7	\N	\N	OR	43	Si le bénéficiaire souhaite tout de même suivre une formation Outils Collaboratifs.	Google WORKSPACE (OC & SLIDES)	\N	AND	f	\N	\N
455	PowerPoint	Si résultat du test = Opérationnel	PPT Opérationnel (TOSA)	PPT Opérationnel (ICDL)	f	f	3	\N	\N	OR	\N	Votre niveau PowerPoint est déjà avancé. Cette formation ne correspond pas à votre profil. Nous vous invitons à choisir une formation plus adaptée ou à continuer ci-dessous si vous souhaitez tout de même suivre ce parcours.	Niveau trop avancé	\N	AND	t	too_advanced	\N
467	SketchUp	Si résultat du test <= Initial	SKETCHUP Opérationnel (ICDL)	GIMP Opérationnel (ICDL)	f	f	0	\N	\N	OR	\N	Votre niveau SketchUp est insuffisant pour cette formation. Nous vous invitons à choisir une formation plus adaptée ou à continuer ci-dessous si vous souhaitez tout de même vous lancer.	Niveau insuffisant	\N	AND	t	too_weak	\N
475	Google Sheets	Si résultat du test = Opérationnel	SHEETS Opérationnel (ICDL)	SLIDES Opérationnel (ICDL)	f	f	5	\N	\N	OR	\N	Si le bénéficiaire souhaite tout de même suivre une formation Google Sheets.	Bureautique Google WORKSPACE (SHEETS & SLIDES)	\N	AND	f	\N	\N
399	Word	Si résultat du test = Basique	WORD Basique (TOSA)	WORD Opérationnel (ICDL)	t	f	2		[]	OR	44		Renforcement WORD	[]	AND	f	\N	\N
483	Word	Si résultat du test = Opérationnel	WORD Basique (TOSA)	WORD Opérationnel (ICDL)	f	f	5	\N	\N	OR	\N	Si vous souhaitez tout de même suivre une formation WORD.	Renforcement WORD	\N	AND	f	\N	\N
413	WordPress	Si résultat du test ≤ Basique	WORDPRESS Basique (TOSA)	WORDPRESS Opérationnel (ICDL)	t	f	1		[]	OR	22		Renforcement WORDPRESS	\N	AND	f	\N	\N
458	WordPress	Si résultat du test = Opérationnel	WORDPRESS Basique (TOSA)	WORDPRESS Opérationnel (ICDL)	f	f	3	\N	\N	OR	\N	Si le bénéficiaire souhaite tout de même suivre une formation WordPress.	Renforcement WORDPRESS	\N	AND	f	\N	\N
406	Google Sheets	Si résultat du test ≤ Basique	SHEETS Opérationnel (ICDL)	DOCS Opérationnel (ICDL)	t	f	1		[]	OR	5		Bureautique Google WORKSPACE (SHEETS & DOCS) 	[]	AND	f	\N	\N
407	Google Docs	Si résultat du test ≤ Basique	DOCS Opérationnel (ICDL)	SHEETS Opérationnel (ICDL)	t	f	1		[]	OR	4		Bureautique Google WORKSPACE (DOCS & SHEETS) 	[]	AND	f	\N	\N
408	Google Slides	Si résultat du test ≤ Basique	SLIDES Opérationnel (ICDL)	DOCS Opérationnel (ICDL)	t	f	1		[]	OR	10		Bureautique Google WORKSPACE (SLIDES & DOCS)	[]	AND	f	\N	\N
449	Google Slides	Si résultat du test ≤ Basique	SLIDES Opérationnel (ICDL)	SHEETS Opérationnel (ICDL)	t	f	2		[]	OR	10		Bureautique Google WORKSPACE (SLIDES & SHEETS) 	[]	AND	f	\N	\N
451	Google Docs	Si résultat du test ≤ Basique	DOCS Opérationnel (ICDL)	SLIDES Opérationnel (ICDL)	t	f	2		[]	OR	4		Bureautique Google WORKSPACE (DOCS & SLIDES) 	[]	AND	f	\N	\N
450	Google Sheets	Si résultat du test ≤ Basique	SHEETS Opérationnel (ICDL)	SLIDES Opérationnel (ICDL)	t	f	2		[]	OR	5		Bureautique Google WORKSPACE (SHEETS & SLIDES ) 	[]	AND	f	\N	\N
431	Word + IA	Si résultat du test ≤ Opérationnel	IA GENERATIVE (INKREA)	WORD Basique (TOSA)	t	f	0		[]	OR	56		IA Générative	\N	AND	f	\N	\N
457	WordPress	Si résultat du test = Opérationnel	WORDPRESS Basique (TOSA)	WORDPRESS Opérationnel (ICDL)	f	f	2	\N	\N	OR	\N	Votre niveau WordPress est déjà avancé. Cette formation ne correspond pas à votre profil. Nous vous invitons à choisir une formation plus adaptée ou à continuer ci-dessous si vous souhaitez tout de même suivre ce parcours.	Niveau trop avancé	\N	AND	t	too_advanced	\N
\.
...
SELECT pg_catalog.setval('public.parcours_rules_id_seq', 486, true);
