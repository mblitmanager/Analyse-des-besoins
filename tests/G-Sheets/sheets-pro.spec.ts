...
test('ICDL Google Sheets-pros', async ({ page }) => {
  ...
  await page.screenshot({ path: "GoogleSheets-pros1.png", fullPage: true });
  ...
  await page.screenshot({ path: "GoogleSheets-pros2.png", fullPage: true });

  await page.getByRole("button", { name: "Continuer" }).click();

  await page.screenshot({ path: "GoogleSheets-pros3.png", fullPage: true });
