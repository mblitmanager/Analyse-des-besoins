...
test('ICDL Google Sheets-initiaux-0', async ({ page }) => {
  ...
  await page.getByText("Il faut passer par Fichier > Enregistrer").click();
  await page.getByText("4C").click();
  ...
  await page.screenshot({ path: "GoogleSheets-initiaux-01.png", fullPage: true });
await page.getByRole("button", { name: "Continuer quand même" }).click();
  ...
  await page.screenshot({ path: "GoogleSheets-initiaux-02.png", fullPage: true });

  await page.getByRole("button", { name: "Continuer" }).click();

  await page.screenshot({ path: "GoogleSheets-initiaux-03.png", fullPage: true });
