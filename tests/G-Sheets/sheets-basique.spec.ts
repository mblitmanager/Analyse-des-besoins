...
test('ICDL Google Sheets-basiques', async ({ page }) => {
  ...
  await page.screenshot({ path: "GoogleSheets-basiques1.png", fullPage: true });
  ...
  await page.screenshot({ path: "GoogleSheets-basiques2.png", fullPage: true });

  await page.getByRole("button", { name: "Continuer" }).click();

  await page.screenshot({ path: "GoogleSheets-basiques3.png", fullPage: true });
