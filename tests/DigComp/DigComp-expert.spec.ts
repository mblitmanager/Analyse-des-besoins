...
test('DigComp-expert', async ({ page }) => {
  ...
  await page.getByText("SOMME.SI.ENS").click();
  await page.getByText("consulte des sites internet").click();
  await page.getByText("Fatigue visuelle").click();

  await page.getByRole("button", { name: "Terminer" }).click();
  // --- Screenshot résultat ---
  await page.waitForTimeout(2000);
  await page.screenshot({ path: "DIGCOMP-Expert.png", fullPage: true });
await page
  ...
  await page.screenshot({ path: "DigComp-Expert2.png", fullPage: true });
  await page.getByRole("button", { name: "Continuer" }).click();
  await page.screenshot({ path: "DigComp-Expert3.png", fullPage: true });
});