...
test('test', async ({ page }) => {
  ...
  await page.getByText('CivilitéMonsieurMadameNomPrénomTéléphonecallConseiller commercial (facultatif)').click();
  ...
  await page.getByRole('textbox', { name: 'Ex: Assistant administratif,' }).fill('s');
  await page.getByRole('textbox', { name: 'Ex: Assistant administratif,' }).click();
  await page.getByRole('textbox', { name: 'Ex: Assistant administratif,' }).fill('sdf');
