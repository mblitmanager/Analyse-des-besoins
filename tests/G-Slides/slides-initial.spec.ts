...
test('ICDL Google Sheets-initiaux', async ({ page }) => {
  ...
  await page.screenshot({ path: "GoogleSheets-initiaux1.png", fullPage: true });
  ...
  await page.screenshot({ path: "GoogleSheets-initiaux2.png", fullPage: true });

  await page.getByRole("button", { name: "Continuer" }).click();

  await page.screenshot({ path: "GoogleSheets-initiaux3.png", fullPage: true });
