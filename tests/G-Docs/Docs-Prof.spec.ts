...
test('ICDL Google Docs', async ({ page }) => {
  ...
  await page.screenshot({ path: "GoogleDocs-Profesionnel1.png", fullPage: true });
  ...
  await page.screenshot({ path: "GoogleDocs-Profesionnel2.png", fullPage: true });

  await page.getByRole("button", { name: "Continuer" }).click();

  await page.screenshot({ path: "GoogleDocs-Profesionnel3.png", fullPage: true });
