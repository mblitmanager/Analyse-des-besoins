...
| --- | --- |
| Rédacteur | Herizo |
| Destinataire | Alexandre, NS Conseil |
...
* Parcours Wordpress : Prise en main + Niveau Intermédiaire
...
Sans adaptation dans les prochains jours, l'entreprise se retrouvera dans l'incapacité de vendre ses formations. Le risque est la fermeture dans un délai de 4 à 6 mois. L'outil est une réponse directe et prioritaire à cette contrainte.
...
* La formation préconisée (ex. : « Madame Marie, nous vous proposons le Parcours Anglais Intermédiaire »)
...
![](CDC_Fonctionnel_images/image_1.png)

**Accueil**

**![](CDC_Fonctionnel_images/image_2.png)**

**Test prérequis**

**![](CDC_Fonctionnel_images/image_3.png)**

**Test positionnement**

**![](CDC_Fonctionnel_images/image_4.png)**

**Choix de formation**

**![](CDC_Fonctionnel_images/image_5.png)![](CDC_Fonctionnel_images/image_6.png)**

**Resultat et recommendation**