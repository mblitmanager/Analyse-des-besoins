...
---
Ce document est un guide concis. Pour des procédures détaillées (sauvegarde DB, restauration, CI/CD), voir la documentation technique du dépôt ou me demander d'ajouter des sections spécifiques.
