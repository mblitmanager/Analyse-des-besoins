...
/**
 * Formation: wordpress | Level: initial | Parcours: 2
 * Niveau ordre: 0
 * Seuil de réussite: 4%
 * 
...
test("wordpress-initial-parcours-2 - WordPress - Initial - Parcours 2", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/wordpress-initial-parcours-2-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/wordpress-initial-parcours-2-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/wordpress-initial-parcours-2-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/wordpress-initial-parcours-2-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: wordpress-initial-parcours-2`);
});
