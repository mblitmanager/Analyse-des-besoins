...
/**
 * Formation: photoshop | Level: basique | Parcours: 2
 * Niveau ordre: 2
 * Seuil de réussite: 4%
 * 
...
test("photoshop-basique-parcours-2 - Photoshop - Basique - Parcours 2", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/photoshop-basique-parcours-2-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/photoshop-basique-parcours-2-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/photoshop-basique-parcours-2-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/photoshop-basique-parcours-2-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: photoshop-basique-parcours-2`);
});
