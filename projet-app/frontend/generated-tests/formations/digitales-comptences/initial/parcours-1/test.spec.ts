...
/**
 * Formation: digitales-comptences | Level: initial | Parcours: 1
 * Niveau ordre: 1
 * Seuil de réussite: 3%
 * 
...
test("digitales-comptences-initial-parcours-1 - Digitales Compétences - Initial - Parcours 1", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/digitales-comptences-initial-parcours-1-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/digitales-comptences-initial-parcours-1-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/digitales-comptences-initial-parcours-1-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/digitales-comptences-initial-parcours-1-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: digitales-comptences-initial-parcours-1`);
});
