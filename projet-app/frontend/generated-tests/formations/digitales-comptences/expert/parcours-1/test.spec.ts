...
/**
 * Formation: digitales-comptences | Level: expert | Parcours: 1
 * Niveau ordre: 5
 * Seuil de réussite: 5%
 * 
...
test("digitales-comptences-expert-parcours-1 - Digitales Compétences - Expert - Parcours 1", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/digitales-comptences-expert-parcours-1-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/digitales-comptences-expert-parcours-1-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/digitales-comptences-expert-parcours-1-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/digitales-comptences-expert-parcours-1-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: digitales-comptences-expert-parcours-1`);
});
