...
/**
 * Formation: excel | Level: initial | Parcours: 4
 * Niveau ordre: 1
 * Seuil de réussite: 3%
 * 
...
test("excel-initial-parcours-4 - Excel - Initial - Parcours 4", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/excel-initial-parcours-4-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/excel-initial-parcours-4-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/excel-initial-parcours-4-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/excel-initial-parcours-4-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: excel-initial-parcours-4`);
});
