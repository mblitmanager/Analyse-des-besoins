...
/**
 * Formation: outlook | Level: initial | Parcours: 1
 * Niveau ordre: 1
 * Seuil de réussite: 3%
 * 
...
test("outlook-initial-parcours-1 - Outlook - Initial - Parcours 1", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/outlook-initial-parcours-1-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/outlook-initial-parcours-1-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/outlook-initial-parcours-1-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/outlook-initial-parcours-1-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: outlook-initial-parcours-1`);
});
