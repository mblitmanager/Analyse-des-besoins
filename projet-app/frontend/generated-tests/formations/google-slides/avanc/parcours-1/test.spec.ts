...
/**
 * Formation: google-slides | Level: avanc | Parcours: 1
 * Niveau ordre: 4
 * Seuil de réussite: 5%
 * 
...
test("google-slides-avanc-parcours-1 - Google Slides - Avancé - Parcours 1", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/google-slides-avanc-parcours-1-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/google-slides-avanc-parcours-1-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/google-slides-avanc-parcours-1-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/google-slides-avanc-parcours-1-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: google-slides-avanc-parcours-1`);
});
