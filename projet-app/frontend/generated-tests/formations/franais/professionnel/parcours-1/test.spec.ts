...
/**
 * Formation: franais | Level: professionnel | Parcours: 1
 * Niveau ordre: 2
 * Seuil de réussite: 4%
 * 
 * Formations proposées:
 * - Formation 1: Français Professionnel - Voltaire
 * - Formation 2: Français Affaires - Voltaire
 */

test("franais-professionnel-parcours-1 - Français - Professionnel - Parcours 1", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/franais-professionnel-parcours-1-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/franais-professionnel-parcours-1-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/franais-professionnel-parcours-1-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/franais-professionnel-parcours-1-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: franais-professionnel-parcours-1`);
});
