...
/**
 * Formation: franais | Level: professionnel | Parcours: 3
 * Niveau ordre: 2
 * Seuil de réussite: 4%
 * 
 * Formations proposées:
 * - Formation 1: Français Découverte - Voltaire
 * - Formation 2: Français Technique - Voltaire
 */

test("franais-professionnel-parcours-3 - Français - Professionnel - Parcours 3", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/franais-professionnel-parcours-3-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/franais-professionnel-parcours-3-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/franais-professionnel-parcours-3-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/franais-professionnel-parcours-3-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: franais-professionnel-parcours-3`);
});
