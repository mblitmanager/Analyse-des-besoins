...
/**
 * Formation: illustrator | Level: oprationnel | Parcours: 2
 * Niveau ordre: 3
 * Seuil de réussite: 5%
 * 
 * Formations proposées:
 * - Formation 1: Illustrator basique (TOSA)
 * - Formation 2: illustrator opérationnel (TOSA)
 */

test("illustrator-oprationnel-parcours-2 - Illustrator - Opérationnel - Parcours 2", async ({ page, context }) => {
  // Navigate to formations page
  await page.goto("https://ns-conseil-ab.mbl-service.com/formations");
  await page.waitForLoadState("networkidle");
  
  // Select formation - search for "Illustrator"
  const formationSelectors = await page.locator("*:has-text(\"Illustrator\")").all();
  ...
  if (!formationFound) {
    console.log("Warning: Formation 'Illustrator' not found on the page");
  }
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/illustrator-oprationnel-parcours-2-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/illustrator-oprationnel-parcours-2-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/illustrator-oprationnel-parcours-2-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/illustrator-oprationnel-parcours-2-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: illustrator-oprationnel-parcours-2`);
});
