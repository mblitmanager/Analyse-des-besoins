...
/**
 * Formation: illustrator | Level: oprationnel | Parcours: 1
 * Niveau ordre: 3
 * Seuil de réussite: 5%
 * 
 * Formations proposées:
 * - Formation 1: Illustrator initial (TOSA)
 * - Formation 2: Illustrator basique (TOSA)
 */

test("illustrator-oprationnel-parcours-1 - Illustrator - Opérationnel - Parcours 1", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/illustrator-oprationnel-parcours-1-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/illustrator-oprationnel-parcours-1-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/illustrator-oprationnel-parcours-1-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/illustrator-oprationnel-parcours-1-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: illustrator-oprationnel-parcours-1`);
});
