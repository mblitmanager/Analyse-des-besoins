...
/**
 * Formation: illustrator | Level: basique | Parcours: 1
 * Niveau ordre: 2
 * Seuil de réussite: 4%
 * 
...
test("illustrator-basique-parcours-1 - Illustrator - Basique - Parcours 1", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/illustrator-basique-parcours-1-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/illustrator-basique-parcours-1-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/illustrator-basique-parcours-1-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/illustrator-basique-parcours-1-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: illustrator-basique-parcours-1`);
});
