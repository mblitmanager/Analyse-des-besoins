...
/**
 * Formation: illustrator | Level: initial | Parcours: 2
 * Niveau ordre: 1
 * Seuil de réussite: 4%
 * 
...
test("illustrator-initial-parcours-2 - Illustrator - Initial - Parcours 2", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/illustrator-initial-parcours-2-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/illustrator-initial-parcours-2-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/illustrator-initial-parcours-2-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/illustrator-initial-parcours-2-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: illustrator-initial-parcours-2`);
});
