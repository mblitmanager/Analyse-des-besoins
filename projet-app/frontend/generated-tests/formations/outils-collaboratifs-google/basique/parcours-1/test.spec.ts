...
/**
 * Formation: outils-collaboratifs-google | Level: basique | Parcours: 1
 * Niveau ordre: 1
 * Seuil de réussite: 4%
 * 
...
test("outils-collaboratifs-google-basique-parcours-1 - Outils Collaboratifs Google - Basique - Parcours 1", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/outils-collaboratifs-google-basique-parcours-1-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/outils-collaboratifs-google-basique-parcours-1-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/outils-collaboratifs-google-basique-parcours-1-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/outils-collaboratifs-google-basique-parcours-1-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: outils-collaboratifs-google-basique-parcours-1`);
});
