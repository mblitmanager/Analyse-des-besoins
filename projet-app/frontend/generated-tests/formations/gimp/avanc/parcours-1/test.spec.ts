...
/**
 * Formation: gimp | Level: avanc | Parcours: 1
 * Niveau ordre: 4
 * Seuil de réussite: 5%
 * 
...
test("gimp-avanc-parcours-1 - Gimp - Avancé - Parcours 1", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/gimp-avanc-parcours-1-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/gimp-avanc-parcours-1-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/gimp-avanc-parcours-1-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/gimp-avanc-parcours-1-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: gimp-avanc-parcours-1`);
});
