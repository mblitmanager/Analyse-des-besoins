...
/**
 * Formation: powerpoint | Level: initial | Parcours: 3
 * Niveau ordre: 1
 * Seuil de réussite: 3%
 * 
...
test("powerpoint-initial-parcours-3 - PowerPoint - Initial - Parcours 3", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/powerpoint-initial-parcours-3-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/powerpoint-initial-parcours-3-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/powerpoint-initial-parcours-3-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/powerpoint-initial-parcours-3-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: powerpoint-initial-parcours-3`);
});
