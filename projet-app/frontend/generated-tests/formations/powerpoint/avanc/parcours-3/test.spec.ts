...
/**
 * Formation: powerpoint | Level: avanc | Parcours: 3
 * Niveau ordre: 4
 * Seuil de réussite: 4%
 * 
...
test("powerpoint-avanc-parcours-3 - PowerPoint - Avancé - Parcours 3", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/powerpoint-avanc-parcours-3-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/powerpoint-avanc-parcours-3-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/powerpoint-avanc-parcours-3-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/powerpoint-avanc-parcours-3-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: powerpoint-avanc-parcours-3`);
});
