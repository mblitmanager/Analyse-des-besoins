...
/**
 * Formation: word | Level: basique | Parcours: 3
 * Niveau ordre: 2
 * Seuil de réussite: 4%
 * 
...
test("word-basique-parcours-3 - Word - Basique - Parcours 3", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/word-basique-parcours-3-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/word-basique-parcours-3-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/word-basique-parcours-3-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/word-basique-parcours-3-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: word-basique-parcours-3`);
});
