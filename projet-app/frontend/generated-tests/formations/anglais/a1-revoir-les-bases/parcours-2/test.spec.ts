...
/**
 * Formation: anglais | Level: a1-revoir-les-bases | Parcours: 2
 * Niveau ordre: 1
 * Seuil de réussite: 6%
 * 
...
test("anglais-a1-revoir-les-bases-parcours-2 - Anglais  - A1 - Revoir les bases - Parcours 2", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/anglais-a1-revoir-les-bases-parcours-2-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/anglais-a1-revoir-les-bases-parcours-2-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/anglais-a1-revoir-les-bases-parcours-2-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/anglais-a1-revoir-les-bases-parcours-2-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: anglais-a1-revoir-les-bases-parcours-2`);
});
