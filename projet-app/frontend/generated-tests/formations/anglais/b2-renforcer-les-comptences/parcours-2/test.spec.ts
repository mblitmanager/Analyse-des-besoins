...
/**
 * Formation: anglais | Level: b2-renforcer-les-comptences | Parcours: 2
 * Niveau ordre: 4
 * Seuil de réussite: 5%
 * 
 * Formations proposées:
 * - Formation 1: Anglais  Développer l'autonomie  - TOEIC
 * - Formation 2: Anglais  Renforcer les compétences - TOEIC
 */

test("anglais-b2-renforcer-les-comptences-parcours-2 - Anglais  - B2 -  Renforcer les compétences - Parcours 2", async ({ page, context }) => {
  ...
  if (!formationFound) {
    console.log("Warning: Formation 'Anglais ' not found on the page");
  }
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/anglais-b2-renforcer-les-comptences-parcours-2-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/anglais-b2-renforcer-les-comptences-parcours-2-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/anglais-b2-renforcer-les-comptences-parcours-2-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/anglais-b2-renforcer-les-comptences-parcours-2-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: anglais-b2-renforcer-les-comptences-parcours-2`);
});
