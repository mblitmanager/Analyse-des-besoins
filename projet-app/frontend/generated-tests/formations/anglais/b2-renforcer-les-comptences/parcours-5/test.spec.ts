...
/**
 * Formation: anglais | Level: b2-renforcer-les-comptences | Parcours: 5
 * Niveau ordre: 4
 * Seuil de réussite: 5%
 * 
 * Formations proposées:
 * - Formation 1: Anglais  Consolider les bases - TOEIC
 * - Formation 2: Anglais  Développer l'autonomie - TOEIC
 */

test("anglais-b2-renforcer-les-comptences-parcours-5 - Anglais  - B2 -  Renforcer les compétences - Parcours 5", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/anglais-b2-renforcer-les-comptences-parcours-5-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/anglais-b2-renforcer-les-comptences-parcours-5-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/anglais-b2-renforcer-les-comptences-parcours-5-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/anglais-b2-renforcer-les-comptences-parcours-5-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: anglais-b2-renforcer-les-comptences-parcours-5`);
});
