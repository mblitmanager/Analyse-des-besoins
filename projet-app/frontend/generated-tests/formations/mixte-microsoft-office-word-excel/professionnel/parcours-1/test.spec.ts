...
/**
 * Formation: mixte-microsoft-office-word-excel | Level: professionnel | Parcours: 1
 * Niveau ordre: 5
 * Seuil de réussite: 4%
 * 
...
test("mixte-microsoft-office-word-excel-professionnel-parcours-1 - Mixte Microsoft Office (Word + Excel) - Professionnel - Parcours 1", async ({ page, context }) => {
  // Navigate to formations page
  await page.goto("https://ns-conseil-ab.mbl-service.com/formations");
  await page.waitForLoadState("networkidle");
  
  // Select formation - search for "Mixte Microsoft Office (Word + Excel)"
  const formationSelectors = await page.locator("*:has-text(\"Mixte Microsoft Office (Word + Excel)\")").all();
  ...
  if (!formationFound) {
    console.log("Warning: Formation 'Mixte Microsoft Office (Word + Excel)' not found on the page");
  }
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/mixte-microsoft-office-word-excel-professionnel-parcours-1-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/mixte-microsoft-office-word-excel-professionnel-parcours-1-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/mixte-microsoft-office-word-excel-professionnel-parcours-1-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/mixte-microsoft-office-word-excel-professionnel-parcours-1-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: mixte-microsoft-office-word-excel-professionnel-parcours-1`);
});
