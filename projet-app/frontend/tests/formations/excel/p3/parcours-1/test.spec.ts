...
/**
 * Formation: excel | Level: p3 | Parcours: 1
 */

test("excel - p3 - Parcours 1", async ({ page, context }) => {
  ...
  await page.screenshot({
    path: "./test-results/screenshots/excel-p3-parcours-1-01-positionnement-end.png",
    fullPage: true
  });
  ...
  // Screenshot results
  await page.screenshot({
    path: "./test-results/screenshots/excel-p3-parcours-1-02-results.png",
    fullPage: true
  });
  
  console.log("Done: excel p3 parcours 1");
});
