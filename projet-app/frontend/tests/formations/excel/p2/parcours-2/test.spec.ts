...
/**
 * Formation: excel | Level: p2 | Parcours: 2
 */

test("excel - p2 - Parcours 2", async ({ page, context }) => {
  ...
  await page.screenshot({
    path: "./test-results/screenshots/excel-p2-parcours-2-01-positionnement-end.png",
    fullPage: true
  });
  ...
  // Screenshot results
  await page.screenshot({
    path: "./test-results/screenshots/excel-p2-parcours-2-02-results.png",
    fullPage: true
  });
  
  console.log("Done: excel p2 parcours 2");
});
