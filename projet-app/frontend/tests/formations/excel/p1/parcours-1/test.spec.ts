...
/**
 * Formation: excel | Level: p1 | Parcours: 1
 */

test("excel - p1 - Parcours 1", async ({ page, context }) => {
  ...
  await page.screenshot({
    path: "./test-results/screenshots/excel-p1-parcours-1-01-positionnement-end.png",
    fullPage: true
  });
  ...
  // Screenshot results
  await page.screenshot({
    path: "./test-results/screenshots/excel-p1-parcours-1-02-results.png",
    fullPage: true
  });
  
  console.log("Done: excel p1 parcours 1");
});
