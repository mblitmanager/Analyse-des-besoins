...
/**
 * Formation: word | Level: p3 | Parcours: 1
 */

test("word - p3 - Parcours 1", async ({ page, context }) => {
  ...
  await page.screenshot({
    path: "./test-results/screenshots/word-p3-parcours-1-01-positionnement-end.png",
    fullPage: true
  });
  ...
  // Screenshot results
  await page.screenshot({
    path: "./test-results/screenshots/word-p3-parcours-1-02-results.png",
    fullPage: true
  });
  
  console.log("Done: word p3 parcours 1");
});
