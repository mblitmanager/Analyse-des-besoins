...
/**
 * Formation: word | Level: p2 | Parcours: 2
 */

test("word - p2 - Parcours 2", async ({ page, context }) => {
  ...
  await page.screenshot({
    path: "./test-results/screenshots/word-p2-parcours-2-01-positionnement-end.png",
    fullPage: true
  });
  ...
  // Screenshot results
  await page.screenshot({
    path: "./test-results/screenshots/word-p2-parcours-2-02-results.png",
    fullPage: true
  });
  
  console.log("Done: word p2 parcours 2");
});
