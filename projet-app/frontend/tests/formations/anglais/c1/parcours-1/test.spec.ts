...
/**
 * Formation: anglais | Level: c1 | Parcours: 1
 * CEFR Level: C1 (Advanced)
 */

test("anglais - c1 - Parcours 1", async ({ page, context }) => {
  ...
  await page.screenshot({
    path: "./test-results/screenshots/anglais-c1-parcours-1-01-positionnement-end.png",
    fullPage: true
  });
  ...
  // Screenshot results
  await page.screenshot({
    path: "./test-results/screenshots/anglais-c1-parcours-1-02-results.png",
    fullPage: true
  });
  
  console.log("Done: anglais c1 parcours 1");
});
