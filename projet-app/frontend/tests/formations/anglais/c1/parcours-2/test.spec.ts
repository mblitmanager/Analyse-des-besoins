...
/**
 * Formation: anglais | Level: c1 | Parcours: 2
 * CEFR Level: C1 (Advanced)
 */

test("anglais - c1 - Parcours 2", async ({ page, context }) => {
  ...
  await page.screenshot({
    path: "./test-results/screenshots/anglais-c1-parcours-2-01-positionnement-end.png",
    fullPage: true
  });
  ...
  // Screenshot results
  await page.screenshot({
    path: "./test-results/screenshots/anglais-c1-parcours-2-02-results.png",
    fullPage: true
  });
  
  console.log("Done: anglais c1 parcours 2");
});
