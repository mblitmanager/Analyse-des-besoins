...
/**
 * Formation: anglais | Level: b1 | Parcours: 1
 * CEFR Level: B1 (Intermediate)
 */

test("anglais - b1 - Parcours 1", async ({ page, context }) => {
  ...
  await page.screenshot({
    path: "./test-results/screenshots/anglais-b1-parcours-1-01-positionnement-end.png",
    fullPage: true
  });
  ...
  // Screenshot results
  await page.screenshot({
    path: "./test-results/screenshots/anglais-b1-parcours-1-02-results.png",
    fullPage: true
  });
  
  console.log("Done: anglais b1 parcours 1");
});
