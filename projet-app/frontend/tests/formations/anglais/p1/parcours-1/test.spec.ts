...
/**
 * Formation: anglais | Level: p1 | Parcours: 1
 */

test("anglais - p1 - Parcours 1", async ({ page, context }) => {
  ...
  await page.screenshot({
    path: "./test-results/screenshots/anglais-p1-parcours-1-01-positionnement-end.png",
    fullPage: true
  });
  ...
  // Screenshot results
  await page.screenshot({
    path: "./test-results/screenshots/anglais-p1-parcours-1-02-results.png",
    fullPage: true
  });
  
  console.log("Done: anglais p1 parcours 1");
});
