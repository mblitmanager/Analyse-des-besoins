...
/**
 * Formation: anglais | Level: p1 | Parcours: 2
 */

test("anglais - p1 - Parcours 2", async ({ page, context }) => {
  ...
  await page.screenshot({
    path: "./test-results/screenshots/anglais-p1-parcours-2-01-positionnement-end.png",
    fullPage: true
  });
  ...
  // Screenshot results
  await page.screenshot({
    path: "./test-results/screenshots/anglais-p1-parcours-2-02-results.png",
    fullPage: true
  });
  
  console.log("Done: anglais p1 parcours 2");
});
