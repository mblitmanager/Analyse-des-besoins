...
/**
 * Formation: anglais | Level: a2 | Parcours: 2
 * CEFR Level: A2 (Elementary)
 */

test("anglais - a2 - Parcours 2", async ({ page, context }) => {
  ...
  await page.screenshot({
    path: "./test-results/screenshots/anglais-a2-parcours-2-01-positionnement-end.png",
    fullPage: true
  });
  ...
  // Screenshot results
  await page.screenshot({
    path: "./test-results/screenshots/anglais-a2-parcours-2-02-results.png",
    fullPage: true
  });
  
  console.log("Done: anglais a2 parcours 2");
});
