...
/**
 * Formation: anglais | Level: a2 | Parcours: 1
 * CEFR Level: A2 (Elementary)
 */

test("anglais - a2 - Parcours 1", async ({ page, context }) => {
  ...
  await page.screenshot({
    path: "./test-results/screenshots/anglais-a2-parcours-1-01-positionnement-end.png",
    fullPage: true
  });
  ...
  // Screenshot results
  await page.screenshot({
    path: "./test-results/screenshots/anglais-a2-parcours-1-02-results.png",
    fullPage: true
  });
  
  console.log("Done: anglais a2 parcours 1");
});
