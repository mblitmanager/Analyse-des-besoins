...
/**
 * Formation: anglais | Level: p2 | Parcours: 1
 */

test("anglais - p2 - Parcours 1", async ({ page, context }) => {
  ...
  await page.screenshot({
    path: "./test-results/screenshots/anglais-p2-parcours-1-01-positionnement-end.png",
    fullPage: true
  });
  ...
  // Screenshot results
  await page.screenshot({
    path: "./test-results/screenshots/anglais-p2-parcours-1-02-results.png",
    fullPage: true
  });
  
  console.log("Done: anglais p2 parcours 1");
});
