...
/**
 * Formation: anglais | Level: p2 | Parcours: 2
 */

test("anglais - p2 - Parcours 2", async ({ page, context }) => {
  // Navigate to formations
  await page.goto("/formations");
  await page.waitForLoadState("networkidle");
  
  // Select formation
  const formationSelector = page.locator("*:has-text(\"Anglais\")").first();
  ...
  await page.screenshot({
    path: "./test-results/screenshots/anglais-p2-parcours-2-01-positionnement-end.png",
    fullPage: true
  });
  ...
  // Screenshot results
  await page.screenshot({
    path: "./test-results/screenshots/anglais-p2-parcours-2-02-results.png",
    fullPage: true
  });
  
  console.log("Done: anglais p2 parcours 2");
});
