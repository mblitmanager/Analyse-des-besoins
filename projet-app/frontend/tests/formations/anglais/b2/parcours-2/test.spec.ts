...
/**
 * Formation: anglais | Level: b2 | Parcours: 2
 * CEFR Level: B2 (Upper-Intermediate)
 */

test("anglais - b2 - Parcours 2", async ({ page, context }) => {
  ...
  await page.screenshot({
    path: "./test-results/screenshots/anglais-b2-parcours-2-01-positionnement-end.png",
    fullPage: true
  });
  ...
  // Screenshot results
  await page.screenshot({
    path: "./test-results/screenshots/anglais-b2-parcours-2-02-results.png",
    fullPage: true
  });
  
  console.log("Done: anglais b2 parcours 2");
});
