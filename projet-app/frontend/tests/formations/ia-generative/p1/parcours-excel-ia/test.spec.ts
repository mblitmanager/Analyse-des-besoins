...
/**
 * Formation: ia-generative | Level: p1 | Parcours: excel-ia
 */

test("ia-generative - p1 - Parcours excel-ia", async ({ page, context }) => {
  // Navigate to formations
  await page.goto("/formations");
  await page.waitForLoadState("networkidle");
  
  // Select formation
  const formationSelector = page.locator("*:has-text(\"IA Générative\")").first();
  ...
  await page.screenshot({
    path: "./test-results/screenshots/ia-generative-p1-parcours-excel-ia-01-positionnement-end.png",
    fullPage: true
  });
  ...
  // Screenshot results
  await page.screenshot({
    path: "./test-results/screenshots/ia-generative-p1-parcours-excel-ia-02-results.png",
    fullPage: true
  });
  
  console.log("Done: ia-generative p1 parcours excel-ia");
});
