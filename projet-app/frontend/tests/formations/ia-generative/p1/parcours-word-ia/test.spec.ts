...
/**
 * Formation: ia-generative | Level: p1 | Parcours: word-ia
 */

test("ia-generative - p1 - Parcours word-ia", async ({ page, context }) => {
  ...
  await page.screenshot({
    path: "./test-results/screenshots/ia-generative-p1-parcours-word-ia-01-positionnement-end.png",
    fullPage: true
  });
  ...
  // Screenshot results
  await page.screenshot({
    path: "./test-results/screenshots/ia-generative-p1-parcours-word-ia-02-results.png",
    fullPage: true
  });
  
  console.log("Done: ia-generative p1 parcours word-ia");
});
