...
await page.getByRole('button', { name: 'Continuer arrow_forward' }).click();
  ...
  await page.getByText("Ils font exactement la même chose").click();

  await expect(page.getByText("Camera Raw")).toBeVisible();
  await page.getByText("En ajoutant du texte").click();
  ...
  // await page.screenshot({ path: "photoshop/Photoshop-basique-OK.png", fullPage: true });

  // await page.getByRole("button", { name: "Continuer avec photoshop arrow_forward" }).click();

  await page.waitForTimeout(3000);
  await page.screenshot({ path: "photoshop/Photoshop-basique.png", fullPage: true });
