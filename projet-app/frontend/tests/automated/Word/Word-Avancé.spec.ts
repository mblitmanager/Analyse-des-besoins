...
test("Word-Avancé", async ({ page }) => {
  ...
  // await expect(page.getByText("sert le logiciel Word")).toBeVisible();
  ...
  await page.screenshot({ path: "Word-Avancé.png", fullPage: true });
  ...
  await page.screenshot({ path: "Word-Avancé2.png", fullPage: true });
});