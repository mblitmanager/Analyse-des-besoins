...
test("Word-Initial", async ({ page }) => {
  ...
  await page.getByText("CTRL + E").click();
  await page.getByText("Couleur de surlignage").click();
  ...
  // await page.getByText("Insertion > Ajouter un sommaire").click();
  ...
  // await page.screenshot({ path: "Word-Initial.png", fullPage: true });
  ...
  await page.screenshot({ path: "Word-Initial2.png", fullPage: true });
});