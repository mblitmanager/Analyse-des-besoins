...
test('ICDL Google Docs', async ({ page }) => {
  ...
  await page.getByText("Utiliser les styles de titre").click();
  await page.getByText("Je fais glisser la bordure de la colonne").click();
  ...
  await page.getByText("Double clic dans le haut du document").click();
  await page.getByText("Insertion > Saut > Saut de page").click();
  ...
  await page.screenshot({ path: "GoogleDocs-avancé1.png", fullPage: true });
  ...
  await page.screenshot({ path: "GoogleDocs-avancé2.png", fullPage: true });

  await page.getByRole("button", { name: "Continuer" }).click();

  await page.screenshot({ path: "GoogleDocs-avancé3.png", fullPage: true });
