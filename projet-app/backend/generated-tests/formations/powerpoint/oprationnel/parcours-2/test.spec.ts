...
/**
 * Formation: powerpoint | Level: oprationnel | Parcours: 2
 * Niveau ordre: 3
 * Seuil de réussite: 4%
 * 
 * Formations proposées:
 * - Formation 1: PowerPoint Initial (TOSA)
 * - Formation 2: PowerPoint Basique (TOSA)
 */

test("powerpoint-oprationnel-parcours-2 - PowerPoint - Opérationnel - Parcours 2", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/powerpoint-oprationnel-parcours-2-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/powerpoint-oprationnel-parcours-2-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/powerpoint-oprationnel-parcours-2-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/powerpoint-oprationnel-parcours-2-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: powerpoint-oprationnel-parcours-2`);
});
