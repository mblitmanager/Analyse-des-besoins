...
/**
 * Formation: photoshop | Level: expert | Parcours: 1
 * Niveau ordre: 5
 * Seuil de réussite: 5%
 * 
...
test("photoshop-expert-parcours-1 - Photoshop - Expert - Parcours 1", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/photoshop-expert-parcours-1-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/photoshop-expert-parcours-1-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/photoshop-expert-parcours-1-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/photoshop-expert-parcours-1-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: photoshop-expert-parcours-1`);
});
