...
/**
 * Formation: photoshop | Level: oprationnel | Parcours: 2
 * Niveau ordre: 3
 * Seuil de réussite: 4%
 * 
 * Formations proposées:
 * - Formation 1: Photoshop initial (TOSA)
 * - Formation 2: Photoshop basique (TOSA)
 */

test("photoshop-oprationnel-parcours-2 - Photoshop - Opérationnel  - Parcours 2", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/photoshop-oprationnel-parcours-2-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/photoshop-oprationnel-parcours-2-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/photoshop-oprationnel-parcours-2-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/photoshop-oprationnel-parcours-2-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: photoshop-oprationnel-parcours-2`);
});
