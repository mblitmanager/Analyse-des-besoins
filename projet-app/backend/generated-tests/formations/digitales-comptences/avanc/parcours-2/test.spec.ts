...
/**
 * Formation: digitales-comptences | Level: avanc | Parcours: 2
 * Niveau ordre: 4
 * Seuil de réussite: 4%
 * 
...
test("digitales-comptences-avanc-parcours-2 - Digitales Compétences - Avancé - Parcours 2", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/digitales-comptences-avanc-parcours-2-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/digitales-comptences-avanc-parcours-2-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/digitales-comptences-avanc-parcours-2-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/digitales-comptences-avanc-parcours-2-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: digitales-comptences-avanc-parcours-2`);
});
