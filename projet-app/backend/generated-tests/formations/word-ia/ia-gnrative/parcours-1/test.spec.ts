...
/**
 * Formation: word-ia | Level: ia-gnrative | Parcours: 1
 * Niveau ordre: 0
 * Seuil de réussite: 3%
 * 
 * Formations proposées:
 * - Formation 1: Word (TOSA)
 * - Formation 2: IA GENERATIVE (INKREA)
 */

test("word-ia-ia-gnrative-parcours-1 - Word + IA - IA Générative  - Parcours 1", async ({ page, context }) => {
  // Navigate to formations page
  await page.goto("https://ns-conseil-ab.mbl-service.com/formations");
  await page.waitForLoadState("networkidle");
  
  // Select formation - search for "Word + IA"
  const formationSelectors = await page.locator("*:has-text(\"Word + IA\")").all();
  ...
  if (!formationFound) {
    console.log("Warning: Formation 'Word + IA' not found on the page");
  }
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/word-ia-ia-gnrative-parcours-1-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/word-ia-ia-gnrative-parcours-1-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/word-ia-ia-gnrative-parcours-1-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/word-ia-ia-gnrative-parcours-1-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: word-ia-ia-gnrative-parcours-1`);
});
