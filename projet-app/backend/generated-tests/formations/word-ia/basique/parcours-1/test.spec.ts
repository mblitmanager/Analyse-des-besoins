...
/**
 * Formation: word-ia | Level: basique | Parcours: 1
 * Niveau ordre: 2
 * Seuil de réussite: 4%
 * 
...
test("word-ia-basique-parcours-1 - Word + IA - Basique - Parcours 1", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/word-ia-basique-parcours-1-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/word-ia-basique-parcours-1-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/word-ia-basique-parcours-1-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/word-ia-basique-parcours-1-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: word-ia-basique-parcours-1`);
});
