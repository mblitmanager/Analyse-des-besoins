...
/**
 * Formation: excel | Level: basique | Parcours: 5
 * Niveau ordre: 2
 * Seuil de réussite: 4%
 * 
...
test("excel-basique-parcours-5 - Excel - Basique - Parcours 5", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/excel-basique-parcours-5-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/excel-basique-parcours-5-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/excel-basique-parcours-5-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/excel-basique-parcours-5-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: excel-basique-parcours-5`);
});
