...
/**
 * Formation: excel | Level: expert | Parcours: 1
 * Niveau ordre: 5
 * Seuil de réussite: 4%
 * 
...
test("excel-expert-parcours-1 - Excel - Expert - Parcours 1", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/excel-expert-parcours-1-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/excel-expert-parcours-1-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/excel-expert-parcours-1-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/excel-expert-parcours-1-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: excel-expert-parcours-1`);
});
