...
/**
 * Formation: excel | Level: expert | Parcours: 2
 * Niveau ordre: 5
 * Seuil de réussite: 4%
 * 
...
test("excel-expert-parcours-2 - Excel - Expert - Parcours 2", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/excel-expert-parcours-2-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/excel-expert-parcours-2-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/excel-expert-parcours-2-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/excel-expert-parcours-2-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: excel-expert-parcours-2`);
});
