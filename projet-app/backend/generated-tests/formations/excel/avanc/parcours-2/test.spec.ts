...
/**
 * Formation: excel | Level: avanc | Parcours: 2
 * Niveau ordre: 4
 * Seuil de réussite: 4%
 * 
...
test("excel-avanc-parcours-2 - Excel - Avancé - Parcours 2", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/excel-avanc-parcours-2-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/excel-avanc-parcours-2-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/excel-avanc-parcours-2-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/excel-avanc-parcours-2-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: excel-avanc-parcours-2`);
});
