...
/**
 * Formation: excel | Level: oprationnel | Parcours: 3
 * Niveau ordre: 3
 * Seuil de réussite: 4%
 * 
 * Formations proposées:
 * - Formation 1: Excel Opérationnel (TOSA)
 * - Formation 2: Excel Avancé (TOSA)
 */

test("excel-oprationnel-parcours-3 - Excel - Opérationnel - Parcours 3", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/excel-oprationnel-parcours-3-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/excel-oprationnel-parcours-3-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/excel-oprationnel-parcours-3-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/excel-oprationnel-parcours-3-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: excel-oprationnel-parcours-3`);
});
