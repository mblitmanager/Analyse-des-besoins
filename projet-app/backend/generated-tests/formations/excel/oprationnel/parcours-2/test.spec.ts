...
/**
 * Formation: excel | Level: oprationnel | Parcours: 2
 * Niveau ordre: 3
 * Seuil de réussite: 4%
 * 
 * Formations proposées:
 * - Formation 1: Excel Initial (TOSA)
 * - Formation 2: Excel basique (TOSA)
 */

test("excel-oprationnel-parcours-2 - Excel - Opérationnel - Parcours 2", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/excel-oprationnel-parcours-2-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/excel-oprationnel-parcours-2-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/excel-oprationnel-parcours-2-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/excel-oprationnel-parcours-2-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: excel-oprationnel-parcours-2`);
});
