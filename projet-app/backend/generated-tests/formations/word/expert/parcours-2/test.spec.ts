...
/**
 * Formation: word | Level: expert | Parcours: 2
 * Niveau ordre: 5
 * Seuil de réussite: 4%
 * 
...
test("word-expert-parcours-2 - Word - Expert - Parcours 2", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/word-expert-parcours-2-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/word-expert-parcours-2-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/word-expert-parcours-2-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/word-expert-parcours-2-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: word-expert-parcours-2`);
});
