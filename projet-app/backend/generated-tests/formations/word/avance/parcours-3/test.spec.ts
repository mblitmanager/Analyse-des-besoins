...
/**
 * Formation: word | Level: avance | Parcours: 3
 * Niveau ordre: 4
 * Seuil de réussite: 5%
 * 
...
test("word-avance-parcours-3 - Word - Avance - Parcours 3", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/word-avance-parcours-3-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/word-avance-parcours-3-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/word-avance-parcours-3-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/word-avance-parcours-3-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: word-avance-parcours-3`);
});
