...
/**
 * Formation: mixte-microsoft-office-word-excel | Level: basique | Parcours: 1
 * Niveau ordre: 1
 * Seuil de réussite: 4%
 * 
...
test("mixte-microsoft-office-word-excel-basique-parcours-1 - Mixte Microsoft Office (Word + Excel) - Basique - Parcours 1", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/mixte-microsoft-office-word-excel-basique-parcours-1-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/mixte-microsoft-office-word-excel-basique-parcours-1-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/mixte-microsoft-office-word-excel-basique-parcours-1-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/mixte-microsoft-office-word-excel-basique-parcours-1-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: mixte-microsoft-office-word-excel-basique-parcours-1`);
});
