...
/**
 * Formation: gimp | Level: basique | Parcours: 1
 * Niveau ordre: 2
 * Seuil de réussite: 3%
 * 
...
test("gimp-basique-parcours-1 - Gimp - Basique - Parcours 1", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/gimp-basique-parcours-1-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/gimp-basique-parcours-1-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/gimp-basique-parcours-1-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/gimp-basique-parcours-1-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: gimp-basique-parcours-1`);
});
