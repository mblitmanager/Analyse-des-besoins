...
/**
 * Formation: franais | Level: affaires | Parcours: 2
 * Niveau ordre: 3
 * Seuil de réussite: 5%
 * 
...
test("franais-affaires-parcours-2 - Français - Affaires - Parcours 2", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/franais-affaires-parcours-2-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/franais-affaires-parcours-2-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/franais-affaires-parcours-2-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/franais-affaires-parcours-2-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: franais-affaires-parcours-2`);
});
