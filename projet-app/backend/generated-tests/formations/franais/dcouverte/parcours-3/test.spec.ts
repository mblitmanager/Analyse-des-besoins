...
/**
 * Formation: franais | Level: dcouverte | Parcours: 3
 * Niveau ordre: 0
 * Seuil de réussite: 4%
 * 
...
test("franais-dcouverte-parcours-3 - Français - Découverte - Parcours 3", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/franais-dcouverte-parcours-3-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/franais-dcouverte-parcours-3-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/franais-dcouverte-parcours-3-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/franais-dcouverte-parcours-3-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: franais-dcouverte-parcours-3`);
});
