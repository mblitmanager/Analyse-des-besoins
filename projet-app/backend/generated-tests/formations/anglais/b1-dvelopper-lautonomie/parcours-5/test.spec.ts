...
/**
 * Formation: anglais | Level: b1-dvelopper-lautonomie | Parcours: 5
 * Niveau ordre: 3
 * Seuil de réussite: 5%
 * 
...
test("anglais-b1-dvelopper-lautonomie-parcours-5 - Anglais  - B1 - Développer l'autonomie - Parcours 5", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/anglais-b1-dvelopper-lautonomie-parcours-5-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/anglais-b1-dvelopper-lautonomie-parcours-5-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/anglais-b1-dvelopper-lautonomie-parcours-5-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/anglais-b1-dvelopper-lautonomie-parcours-5-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: anglais-b1-dvelopper-lautonomie-parcours-5`);
});
