...
/**
 * Formation: anglais | Level: b2-renforcer-les-comptences | Parcours: 3
 * Niveau ordre: 4
 * Seuil de réussite: 5%
 * 
...
test("anglais-b2-renforcer-les-comptences-parcours-3 - Anglais  - B2 -  Renforcer les compétences - Parcours 3", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/anglais-b2-renforcer-les-comptences-parcours-3-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/anglais-b2-renforcer-les-comptences-parcours-3-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/anglais-b2-renforcer-les-comptences-parcours-3-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/anglais-b2-renforcer-les-comptences-parcours-3-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: anglais-b2-renforcer-les-comptences-parcours-3`);
});
