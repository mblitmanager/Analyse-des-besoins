...
test("anglais-a2-consolider-les-bases-parcours-1 - Anglais  - A2 - Consolider les bases - Parcours 1", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/anglais-a2-consolider-les-bases-parcours-1-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/anglais-a2-consolider-les-bases-parcours-1-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/anglais-a2-consolider-les-bases-parcours-1-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/anglais-a2-consolider-les-bases-parcours-1-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: anglais-a2-consolider-les-bases-parcours-1`);
});
