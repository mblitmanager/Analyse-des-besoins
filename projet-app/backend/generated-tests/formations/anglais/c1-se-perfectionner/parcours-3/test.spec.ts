...
/**
 * Formation: anglais | Level: c1-se-perfectionner | Parcours: 3
 * Niveau ordre: 5
 * Seuil de réussite: 5%
 * 
...
test("anglais-c1-se-perfectionner-parcours-3 - Anglais  - C1 - Se perfectionner - Parcours 3", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/anglais-c1-se-perfectionner-parcours-3-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/anglais-c1-se-perfectionner-parcours-3-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/anglais-c1-se-perfectionner-parcours-3-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/anglais-c1-se-perfectionner-parcours-3-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: anglais-c1-se-perfectionner-parcours-3`);
});
