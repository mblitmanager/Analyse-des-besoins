...
/**
 * Formation: outils-collaboratifs-google | Level: initial | Parcours: 1
 * Niveau ordre: 0
 * Seuil de réussite: 3%
 * 
...
test("outils-collaboratifs-google-initial-parcours-1 - Outils Collaboratifs Google - Initial - Parcours 1", async ({ page, context }) => {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/outils-collaboratifs-google-initial-parcours-1-01-positionnement-end.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 1 saved: ./test-results/screenshots/outils-collaboratifs-google-initial-parcours-1-01-positionnement-end.png`);
  } catch (e) {
  ...
  try {
    await page.screenshot({
      path: "./test-results/screenshots/outils-collaboratifs-google-initial-parcours-1-02-results.png",
      fullPage: true
    });
    console.log(`📸 Screenshot 2 saved: ./test-results/screenshots/outils-collaboratifs-google-initial-parcours-1-02-results.png`);
  } catch (e) {
  ...
  console.log(`✅ Test completed: outils-collaboratifs-google-initial-parcours-1`);
});
